    ...
    public static void main(String[] args) {
        ...
        switch (tipoFigura) {
            case 1: // Círculo
                ...
                Círculo circulo = new Círculo(nombre, color, radio);
            ...
            case 2: // Rectángulo
                ...
                Rectángulo rectangulo = new Rectángulo(nombre, color, lado1, lado2);
            ...
            case 3: // Triángulo
                ...
                Triángulo triangulo = new Triángulo(nombre, color, base, altura);
